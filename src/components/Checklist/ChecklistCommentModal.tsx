...
interface ChecklistCommentModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export default function ChecklistCommentModal({ 
  isOpen, 
  onClose, 
  onSubmit, 
  taskTitle 
}: ChecklistCommentModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg w-full max-w-md mx-4">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          <div className="mb-4">
            <p className="text-sm text-warm-600 mb-2">Tâche :</p>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              placeholder="Ajoutez votre commentaire sur cette tâche..."
            />
          </div>
